...
- (NSArray *)readFuncArr {
    NSArray *arr = @[TRLocalizedString(@"绑定设备", nil),
                     TRLocalizedString(@"设备状态(获取)", nil),
                     TRLocalizedString(@"设备状态(设置)", nil),
                     TRLocalizedString(@"查找设备", nil),
                     TRLocalizedString(@"拍照控制", nil),
                     TRLocalizedString(@"获取电池电量", nil),
                     TRLocalizedString(@"获取设备版本信息", nil),
                     TRLocalizedString(@"时间时区(获取)", nil),
                     TRLocalizedString(@"时间时区(设置)", nil),
                     TRLocalizedString(@"用户信息(获取)", nil),
                     TRLocalizedString(@"用户信息(设置)", nil),
                     TRLocalizedString(@"一天运动目标(获取)", nil),
                     TRLocalizedString(@"一天运动目标(设置)", nil),
                     TRLocalizedString(@"蓝牙系统配对", nil),
                     TRLocalizedString(@"消息推送开关(获取)", nil),
                     TRLocalizedString(@"消息推送开关(设置)", nil),
                     TRLocalizedString(@"获取当前设备展示数据", nil),
                     TRLocalizedString(@"健康数据检测开关(获取)", nil),
                     TRLocalizedString(@"健康数据检测开关(设置)", nil),
                     TRLocalizedString(@"恢复出厂设置", nil),

                     TRLocalizedString(@"心率检测间隔(获取)", nil),
                     TRLocalizedString(@"心率检测间隔(设置)", nil),
                     TRLocalizedString(@"常用联系人(获取)", nil),
                     TRLocalizedString(@"常用联系人(设置)", nil),
                     TRLocalizedString(@"紧急联系人(获取)", nil),
                     TRLocalizedString(@"紧急联系人(设置)", nil),
                     TRLocalizedString(@"勿扰(获取)", nil),
                     TRLocalizedString(@"勿扰(设置)", nil),
                     TRLocalizedString(@"闹钟(获取)", nil),
                     TRLocalizedString(@"闹钟(设置)", nil),
                     TRLocalizedString(@"久坐提醒(获取)", nil),
                     TRLocalizedString(@"久坐提醒(设置)", nil),
                     TRLocalizedString(@"喝水提醒(获取)", nil),
                     TRLocalizedString(@"喝水提醒(设置)", nil),
                     TRLocalizedString(@"推送天气", nil),
                     TRLocalizedString(@"事件提醒(获取)", nil),
                     TRLocalizedString(@"事件提醒(设置)", nil),

                     TRLocalizedString(@"同步运动", nil),
                     TRLocalizedString(@"同步记步/睡眠", nil),
                     TRLocalizedString(@"同步心率", nil),
                     TRLocalizedString(@"同步血压", nil),
                     TRLocalizedString(@"同步血氧", nil),
                     TRLocalizedString(@"同步压力", nil),
                     TRLocalizedString(@"同步梅脱", nil),
                     TRLocalizedString(@"同步温度", nil),
                     TRLocalizedString(@"同步Mai", nil),
                     TRLocalizedString(@"获取数据有效日期列表", nil),
                     
                     TRLocalizedString(@"文件传输(表盘)", nil),
                     TRLocalizedString(@"获取表盘信息", nil),
                     TRLocalizedString(@"切换当前显示表盘", nil),
                     TRLocalizedString(@"文件传输(UI)", nil),
                     TRLocalizedString(@"文件传输(语言)", nil),
                     
                     TRLocalizedString(@"实时数据开关(获取)", nil),
                     TRLocalizedString(@"实时数据开关(设置)", nil),
                     
                     TRLocalizedString(@"同步血糖", nil),
                     TRLocalizedString(@"运动模式配置(获取)", nil),
                     TRLocalizedString(@"运动模式配置(设置)", nil),

                     TRLocalizedString(@"网络：表盘列表", nil),
                     TRLocalizedString(@"网络：固件版本信息", nil),
                     TRLocalizedString(@"网络：UI版本信息", nil),
                     TRLocalizedString(@"网络：字库列表", nil),
